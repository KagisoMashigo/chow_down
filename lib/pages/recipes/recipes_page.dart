import 'package:chow_down/components/cards/recipe_square.dart';
...
class _RecipeHomePageState extends State<RecipeHomePage> {
  RecipeHomeCubit _recipeHomeCubit;
  @override
  void initState() {
      ...
      body: Container(
        ...
        child: BlocConsumer<RecipeHomeCubit, RecipeHomeState>(
          ...
          builder: (context, state) {
            if (state is RecipeHomeInitial) {
              return _buildInitialInput();
            } else if (state is RecipeHomeLoading) {
